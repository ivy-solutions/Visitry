...
Meteor.startup(function ()  {
  ...
  if (Meteor.users.find().count() === 0) {
    ...
    Accounts.createUser({
      username: 'Sarahc', email: 'sarahcoletti12@gmail.com', password: 'Visitry99', roles: ['visitor'],
    ...
    Accounts.createUser({
      username: 'Vivian', email: 'viv@aol.com', password: 'Visitry99', roles: ['visitor'],
      userData: {
        firstName: 'Vivian',
        lastName: 'Visitor',
    ...
    Roles.setUserRoles(Meteor.users.findOne({username:'Vivian'})._id,['visitor']);
    Accounts.createUser({
      username: 'requester1', email: 'rq1@gmail.com', password: 'Visitry99', roles: ['requester'],
      userData: {
        firstName: 'Raoul',
        lastName: 'Robbins',
        agencyIds: [agency._id],
    ...
    Roles.setUserRoles(Meteor.users.findOne({username:'requester1'})._id,['requester']);
    user = Accounts.createUser({
      username: 'requester2', email: 'rq2@gmail.com', password: 'Visitry99', roles: ['requester'],
      userData: {
        firstName: 'Rita',
        lastName: 'Smith',
        agencyIds: [agency._id],
    ...
    Accounts.createUser({
      username: 'requester3', email: 'rq3@gmail.com', password: 'Visitry99',roles: ['requester'],
      userData: {
        firstName: 'Ron',
        lastName: 'Wang',
        agencyIds: [agency._id],
    ...
    Roles.setUserRoles(Meteor.users.findOne({username:'requester2'})._id,['requester']);
    Accounts.createUser({
      username: 'admin', email: 'admin@aol.com', password: 'Visitry99', roles: ['administrator'],
      userData: {
        firstName: 'Amy',
    ...
    Roles.setUserRoles(Meteor.users.findOne({username:'admin'})._id,['administrator']);
